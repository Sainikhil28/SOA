...
`}</style>
      ...
      <div className="row mb-4">
        <div className="col-md-8">
          <h2 className="mb-3">LifeBridge</h2>
        ...
        <div className="col-md-4 text-end">
          <img
            src="https://assets.futuregenerali.in/blogs-image/health/family-health-insurance-vs-individual-plans.webp"
      ...
      <div className="bg-light p-4 mt-5 rounded shadow-sm">
        <h4 className="mb-3">LifeBridge</h4>
