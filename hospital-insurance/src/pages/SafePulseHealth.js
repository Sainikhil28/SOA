...
const SafePulseHealth = () => {
  ...
  .choose-card:hover {
    ...
    background-color:rgb(27, 84, 141) !important;
...
`}</style>
      ...
      <div className="row mb-4">
        <div className="col-md-8">
          <h2 className="mb-3">SafePulse Health – Family Health Optima</h2>
          <p className="text-justify">
            Health premier policy refers to a comprehensive health insurance plan that offers coverage to a wide range of medical expenses, like hospitalization, pre and post-hospitalization costs. In general, the policy includes in-patient treatment, day care, ambulance, AYUSH, non-medical items, and more. Some policies provide maternity, critical illness, air ambulance, check-ups, restoration benefits, and more. With sum insured options from ₹10 Lakhs to ₹1 Crore, Starhealth policy provides financial protection with peace of mind and rewards for staying fit.
          </p>
        </div>
        <div className="col-md-4 text-end">
          <img
            src="https://www.axisbank.com/images/default-source/progress-with-us_new/what-is-family-floater-health-insurance.jpg?sfvrsn=88e31756_2"
      ...
      <div className="bg-light p-4 mt-5 rounded shadow-sm">
        <h4 className="mb-3">SafePulse Health – Family Health Policy</h4>
...
export default SafePulseHealth;
